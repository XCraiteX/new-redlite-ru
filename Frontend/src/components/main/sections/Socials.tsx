        ...
        <section id="contacts" className="h-screen w-screen flex-shrink-0 snap-center flex items-center justify-center flex-col overflow-hidden">
            <div className="w-[60%] flex justify-center flex-col">
                ...
                <motion.div initial={{opacity: 0}} whileInView={{opacity: 1}} transition={{duration: 0.4, delay: 0.8}}
                    ...
                    <Link href="https://discord.gg/mPKa2sUrmZ" className="glass glow_button py-3 px-6 min-w-[220px] flex justify-center gap-3 text-3xl rounded-full">
              <FaDiscord/>
              Discord
              <span className="text-white/10">|</span>
              <span className="flex justify-center items-center gap-2 text-2xl text-white/60"><FaUsers/>{data?.discord_members}</span>
            </Link>

            <Link href="https://t.me/redlite_clan" className="glass glow_button py-3 px-6 min-w-[220px] flex justify-center gap-3 text-3xl rounded-full">
              <FaTelegramPlane/>
              Telegram
              <span className="text-white/10">|</span>
