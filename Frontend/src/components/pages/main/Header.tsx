        ...
        <AnimatePresence mode="wait">
            {isPageVisible && (
                <motion.header 
                    ...
                    <div className="glass px-5 nav-a py-[0.4rem] rounded-full flex gap-2 items-center bg-[#ff1111]/10 backdrop-blur-[12px] border-1 border-white/10 shadow-[#ff0000]/50 hover:shadow-[0_0_6px_1px]  hover:bg-[#ff0000]/16" id="header_logo">
                        <GiStarSattelites/>
                        <h1>REDLITE</h1>
                    </div>
