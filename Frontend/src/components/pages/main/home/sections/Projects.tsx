...
export default function Projects() { 
    return(
        ...
        <div className="p-8 rounded-2xl mt-14 w-full flex flex-col items-center" id="projects-container">
          <motion.h2 initial={{x: 20, opacity: 0}} whileInView={{x: 0, opacity: 1}} transition={{duration: 0.4, delay: 0.4}}
            className="text-5xl font-bold mb-5 flex gap-2 headers-text"><FaProjectDiagram/>Наши проекты</motion.h2>
          
          <div className="flex flex-col w-[60%] mt-5 gap-12 pb-12" id="projects-list">
